...
> Answer: The most common effects that are studied are population and mortality. Both of these effects have values over 1000 (population=1803 and mortality=1493).
...
```{r}
#Use function 'geom_freqpoly' to create a plot. 
ggplot(Neonics) +
