...
#EPAair_PM24_NC2019_processed
write.csv(EPAair_PM24_NC2019, file = "./Data/Processed/EPAair_PM24_NC2019_processed.csv", row.names=FALSE)
...
#8 Wrangle the new dataset with a pipe function (%>%).
