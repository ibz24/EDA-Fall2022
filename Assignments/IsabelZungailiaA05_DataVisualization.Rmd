...
```{r}
#4Plot total phosphorus (`tp_ug`) by phosphate (`po4`)
...
plot_grid(boxplotA + theme(legend.position = "none", axis.title.x = element_blank()), boxplotB +  theme(legend.position = "none", axis.title.x = element_blank()), boxplotC + theme(legend.position = "bottom"), nrow = 3, align = 'hv', axis = "bt", rel_heights = c(1.6, 1.7, 2.3))
