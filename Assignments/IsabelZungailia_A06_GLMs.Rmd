...
#HSD.test to extract groupings for pairwise relationships (referenced in question #17)
...
>Answer: We could use the HSD.test to extract groupings for pairwise relationships and explore whether the lakes have distinct mean temperatures.
