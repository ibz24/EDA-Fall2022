...
>Answer: We could use a two-sample t-test to test the hypothesis that the mean temperatures of the Peter Lake and Paul Lake are equivalent. HSD.test to extract groupings for pairwise relationships and explore whether the lakes have distinct mean temperatures.
