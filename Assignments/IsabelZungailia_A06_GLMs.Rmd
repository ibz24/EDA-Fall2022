...
#The p-value indicates whether the relationshp between the variables is statistically significant. In this model, the p-value is 2.2e-16, which is very close to zero and indicates that there is a strong relationship between depth and temperature (we can reject the null hypothesis). We can explain temperature by changes in depth.
