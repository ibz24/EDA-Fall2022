...
Asheville_2010_thru_2019 <- lapply(X = the_years,
                  FUN = scrape.it,
                  the_pwsid=pwsid) 

Asheville_2010_thru_2019 <- map(the_years,scrape.it, the_pwsid='01-11-010')

Asheville_2010_thru_2019_final <- bind_rows(Asheville_2010_thru_2019)

ggplot(Asheville_2010_thru_2019_final,aes(x=Date,y=Max_Withdrawals_mgd)) + 
  geom_line() + 
  geom_smooth(method="loess",se=FALSE) +
