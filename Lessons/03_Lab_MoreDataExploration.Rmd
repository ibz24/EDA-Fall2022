...
```{r DataExercise-1a}
vectorH <- c(93,93,73,78,85,82,78,75,73,71)
vectorL <- c(65,53,48,59,61,54,51,51,52,55)
```
...
vectorH_C <- conversion(vectorH)
vectorL_C <- conversion(vectorL)
...
```{r DataExercise-1c}
d <- cbind(vectorH, vectorL, vectorH_C, vectorL_C)
```
