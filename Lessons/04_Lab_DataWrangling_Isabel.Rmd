...
NTL.phys.data.TuesdayLake90to99 <- filter(NTL.phys.data,lakename=="Tuesday Lake" & year4>=1990 & year4<=1999)

```
Question: Why don't we filter using row numbers?

> Answer: Row numbers can change, and we're more interested in the characters not how the rows are arranged. 
...
Ex4 <-
  ...
  summarise(mean_surface_temp = mean(temperature_C))
