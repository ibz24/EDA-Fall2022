...
editor_options: 
  chunk_output_type: console    #since we will have a lot of outputs
---
...
#when we plot this, it is clear that we don't have a linear relationship between X and Y
```
...
PeterPaul.chem.nutrients <- filter(PeterPaul.chem.nutrients, 
                                   irradianceWater != 0 & irradianceWater < 5000) #remove values that are 0 or < 5000
